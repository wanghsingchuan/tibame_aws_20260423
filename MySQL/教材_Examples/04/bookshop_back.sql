...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `bookshop` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `employee` VALUES (1,'Mary',NULL),(2,'John',1),(3,'Ben',1),(4,'Joe',2),(5,'James',2),(6,'Betty',3);
...
CREATE TABLE `order_detail` (
  ...
  CONSTRAINT `fk_order_detail_order_master` FOREIGN KEY (`order_id`) REFERENCES `order_master` (`order_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-08-17 11:35:54
